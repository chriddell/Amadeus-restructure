<?php
  if(isset($_POST["submit"])){
    ...
    //$EmailTo = "chrisliddell@otmcreate.com";
    // Subject
    ...
    if($name != "" && $company != "" && $email != ""){
      ...
      if ( $formName == "CONTACT" ) {
        header( "Location:http://www.amadeus.com/passion/contactus-thankyou.html" );
      } elseif ( $formName == "DEMO" ) {
        header( "Location:http://www.amadeus.com/passion/demos.html" );
      }
    } else {
